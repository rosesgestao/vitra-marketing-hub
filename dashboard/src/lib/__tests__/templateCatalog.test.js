...
describe('catalogo de templates por marca', () => {
  it('Imobiliaria tem 10 templates aprovados e Premium tem 2', () => {
    expect(creativeTemplatesForBrand(BRAND_SCOPES.imobiliaria)).toHaveLength(10)
...
describe('render-version (fonte unica no catalogo — Fase 3)', () => {
  ...
  it('renderVersionForFamily retorna a versao das families versionadas e null para as demais', () => {
    ...
    expect(renderVersionForFamily('vitra-imobiliaria-hero-checklist')).toBe('hero-checklist-safezone-v2')
