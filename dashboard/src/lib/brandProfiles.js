...
export const BRAND_PROFILES = {
  [BRAND_SCOPES.premium]: {
    ...
    areaKicker: 'Conteúdo · alto padrão',
    trafficKicker: 'Centro operacional de midia paga',
    dashboardTitle: 'Conteúdo Vitra Premium',
    trafficTitle: 'Tráfego Pago Premium',
    dashboardSubtitle: 'Planejamento, criação e curadoria de conteúdo orgânico — presença e consistência da Vitra Premium nas redes sociais.',
  ...
  [BRAND_SCOPES.imobiliaria]: {
    ...
    areaKicker: 'Conteúdo orgânico · marca-mãe',
    trafficKicker: 'Centro operacional de midia paga',
    dashboardTitle: 'Conteúdo Vitra Imobiliária',
    trafficTitle: 'Tráfego Pago Vitra Imobiliária',
    dashboardSubtitle: 'Planejamento, criação, organização e acompanhamento de publicações orgânicas — presença e consistência da marca-mãe nas redes sociais.',
