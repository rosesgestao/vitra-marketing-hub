...
139. **Imóvel Vendido (post): blur do fundo −50%** — a pedido, o blur do fundo do empreendimento caiu de 26px → 13px (intensidade −50%); nenhuma outra alteração. build OK. Commit eeec532.
